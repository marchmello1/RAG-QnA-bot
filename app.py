...
def main():
    ...
    # Add a placeholder to reserve space for the message input box
    message_input_placeholder = st.empty()
    
    # Move the message input box to the bottom of the page
    st.sidebar.text_input("Enter your message", key="user_question")
